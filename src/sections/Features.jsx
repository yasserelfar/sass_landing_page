          ...
          >
            {features.map(({ id, icon, caption, title, text, button }) => (
              ...
              >
                ...
                <h2
                  className="max-w-400 mb-7 h3 text-p4 max-md:mb-6
                                max-md:h5"
                >
                  {title}
                </h2>
            ...
            >
              ...
              {details.map(({ id, icon, title }) => (
                <li key={id} className="relative pt-16 px-4 pd-14">
                  <d className="absolute top-0 left-1/2 bottom-0 bg-s3/20 z-10 w-[1px] h-full" />

                  <div
                    className="flex items-center justify-center mx-auto mb-3 border-2 border-s2 
                                    rounded-full hover:border-s4
