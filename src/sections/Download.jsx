...
const Download = () => {
  return (
    <section>
      <Element name="download" className="g7 relative pb-32 pt-24 max-lg:24">
        <div className="container">
          <div className="flex items-center">
            <div
              className="relative mr-6 flex-540 max-xl:flex-280
            max-lg:flex256 max-md:flex-100"
            >
                ...
                {links.map(({ id, url, icon }) => (
                  ...
                  >
                    <a
                      href={url}
                      target="_blank"
                      className="size-22 relative flex items-center justify-center rounded-half
                      border-2 border-s2  bg-s1 transition-borderColor duration-500
            ...
            <div className="mb-10 max-md:hidden">
              ...
              relative w-[955px] border-s2 p-6 border-2
              "
              >
